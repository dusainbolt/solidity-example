...
import "./24_minimal_store_contract.sol";
...
contract StoreFactory is MinimalProxy {
    address public owner;
    address public impl;

    MinimalProxy proxy = new MinimalProxy();

    event CloneSuccess(address storeAddress);
    ...
    function cloneStore() public OnlyOwner {
        address storeAddress = proxy.clone(impl);
        emit CloneSuccess(storeAddress);
    }
}
